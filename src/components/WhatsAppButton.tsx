...
export function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-[0_12px_30px_rgba(37,211,102,0.35)] transition hover:scale-[1.04] hover:shadow-[0_14px_34px_rgba(37,211,102,0.45)]"
    >
