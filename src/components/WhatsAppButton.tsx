...
export function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className="safe-bottom fixed z-50 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-[0_10px_28px_rgba(37,211,102,0.35)] transition hover:scale-[1.03] sm:h-14 sm:w-14"
    >
